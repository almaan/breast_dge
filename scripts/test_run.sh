...
gene_file="/home/alma/ST-2018/CNNp/DGE/data/test_data/random_1000.dat"

Rscript ./dge_trial_test.r --count_dir $count_dir --feature_dir $feature_dir --design $design_file --gene_file $gene_file
